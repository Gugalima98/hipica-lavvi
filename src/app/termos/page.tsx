...
export const metadata: Metadata = {
    title: "Termos de Uso | Jardim da Hípica",
    description: "Termos e condições de uso do site oficial Jardim da Hípica.",
};
            ...
            <main className="flex-1 py-12 sm:py-24">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-gray-700 space-y-6">
                    ...
                    <p className="mt-6 text-lg leading-8 text-gray-600">
                        Ao acessar ao site <a href="https://www.jardinsdahipica.com" className="text-secondary hover:underline">Jardim da Hípica</a>, concorda em cumprir estes termos de serviço, todas as leis e regulamentos aplicáveis e concorda que é responsável pelo cumprimento de todas as leis locais aplicáveis. Se você não concordar com algum desses termos, está proibido de usar ou acessar este site. Os materiais contidos neste site são protegidos pelas leis de direitos autorais e marcas comerciais aplicáveis.
                    </p>
