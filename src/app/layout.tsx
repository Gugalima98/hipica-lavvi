  ...
  "@graph": [
    {
      ...
      "name": "Jardim da Hípica Lavvi Vendas",
  ...
  return (
    <html lang="pt-BR" className="scroll-smooth">
      <head>
        ...
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-VR6JNELQ2W"
