...
export const metadata: Metadata = {
    title: "Política de Privacidade | Jardim da Hípica",
    description: "Como tratamos seus dados no site oficial Jardim da Hípica.",
};
            ...
            <main className="flex-1 py-12 sm:py-24">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-gray-700 space-y-6">
                    ...
                    <p className="mt-6 text-lg leading-8 text-gray-600">
                        A sua privacidade é importante para nós. É política do Jardim da Hípica respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://www.jardinsdahipica.com" className="text-secondary hover:underline">Jardim da Hípica</a>, e outros sites que possuímos e operamos.
                    </p>
