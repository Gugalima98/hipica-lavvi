                    ...
                    <div className="relative flex items-center justify-between gap-8 rounded-full border border-white/10 bg-primary/80 backdrop-blur-md px-6 py-3 shadow-2xl shadow-black/20 ring-1 ring-white/10">
                        ...
                        <div className="flex items-center gap-3 pl-4 border-l border-white/10">
                            <Button
                                ...
                                asChild
                            >
                                <Link href="https://wa.me/5511978519899?text=Olá, gostaria de entrar na Lista VIP do Jardim da Hípica." target="_blank">
                                    Lista VIP
                                </Link>
                            </Button>
                ...
                >
                    <div className="flex flex-col gap-6">
                        ...
                        <Button
                            ...
                            asChild
                        >
                            <Link href="https://wa.me/5511978519899?text=Olá, gostaria de entrar na Lista VIP do Jardim da Hípica." target="_blank" onClick={() => setIsMobileMenuOpen(false)}>
                                Entrar na Lista VIP
                            </Link>
                        </Button>
                    </div>
